...
Microsoft Azure アカウントをお持ちでない場合は、まず Microsoft Azure にサインアップします。次に、ネットアップリソースプロバイダを登録して Azure NetApp Files にアクセスします。

.手順
. Microsoft Azure アカウントをすでにお持ちの場合は、手順 4 に進みます。
...
登録が完了したら、 Azure NetApp Files でネットアップアカウントを作成します。
