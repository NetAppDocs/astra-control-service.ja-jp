...
* * ストレージバックエンド * ：
+
** Astra Control Service で使用される https://www.netapp.com/cloud-services/azure-netapp-files/["Azure NetApp Files の特長"^] AKS クラスタのストレージバックエンドとして。
** Astra Control Serviceは、バックエンドストレージオプションとしてAzure Managed Disksもサポートします。
...
* Astra Control Service で使用される https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["NetApp Cloud Volumes Service for Google Cloud"^] GKEクラスタのストレージバックエンドとして。
* Astra Control Serviceは、バックエンドストレージオプションとしてGoogle Persistent Diskもサポートします。


endif::azure[]

+** Astra Control Centerは、次のストレージバックエンドを使用します。
