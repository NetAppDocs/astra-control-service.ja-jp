...
[role="lead"]
Astra Control Serviceは、永続的ボリュームのストレージバックエンドオプションとして、Google Cloud、Google Persistent Disk、またはNetApp Cloud Volumes ONTAP 用のCloud Volumes Service をサポートします。
