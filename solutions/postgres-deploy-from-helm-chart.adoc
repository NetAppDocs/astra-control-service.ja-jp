...
Bitnami Helm チャートから Postgres を導入する方法について説明します。クラスタに Postgres を導入したら、 Astra Control にアプリケーションを登録できます。

Postgres は Astra 向けの検証済みアプリケーションです。 link:../learn/validated-vs-standard.html["検証済みアプリケーションと標準アプリケーションの違いをご確認ください"]。
